...
namespace FSLL.MS.Core.DAL
{
    ...
    /// </summary>
    public partial class Repository<TObject> : IRepository<TObject> 
        where TObject: class
    {
        protected fsll_coreEntities Context = null;
        protected bool _Shared = false;
        public Repository(fsll_coreEntities context)
        {
            Context = context;
            _Shared = true;
        }
        ...
        public virtual int Update(TObject TObject)
        {
            ...
            entry.State = EntityState.Modified; // System.Data.Entity.EntityState.Modified;
            return !_Shared ? Context.SaveChanges() : 0;
